...
import CapsuleSkeleton from '@/components/Skeleton/CapsuleSkeleton'
...
const ModalTest = () => {
  ...
  return (
    ...
    //   <ModalButton type="button" onClick={handleButtonClick} color="secondary">
    //     취소
    //   </ModalButton>
    //   <ModalButton type="button" onClick={handleButtonClick}>
    //     완료
    //   </ModalButton>
    //   <ModalButton type="button" onClick={handleButtonClick} size="small" color="secondary">
    //     취소
    //   </ModalButton>
    //   <ModalButton type="button" onClick={handleButtonClick} size="small">
    //     삭제
    //   </ModalButton>
    // </Modal>
  )
